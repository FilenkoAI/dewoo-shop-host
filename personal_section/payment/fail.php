...
<div class="wrapp-txt">
    <div class="container">
        <p style="margin-top: 20px; text-align: center">Ошибка при оплате заказа. Пожалуйста, повторите оплату.</p>
		<p><a href="/personal_section/payment/?ORDER_ID=<?=$_REQUEST["ORDER_ID"]?>">Оплатить</a></p>
