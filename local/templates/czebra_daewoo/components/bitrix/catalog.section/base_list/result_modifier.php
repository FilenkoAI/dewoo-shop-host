...
$itemsInFavorites = \Czebra\Project\Fav::GetList();
foreach ($arResult['ITEMS'] as &$arItem) {
    ...
    $arItem['CZ_PROPS']['IN_FAV'] = in_array($arItem['ID'], $itemsInFavorites) ? 'Y' : 'N';
    ...
    // управляемая сортировка свойств
    $sort = new \Czebra\Project\ProductDecorator\Characteristics($arItem['DISPLAY_PROPERTIES'], $arItem['ID'], $arItem['IBLOCK_SECTION_ID'] );
    $arItem['DISPLAY_PROPERTIES'] = $sort->sort();
}
