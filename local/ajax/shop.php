        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="delivery-terms">
                    <div class="text-bottom-select-city">Доставка товара возможна в любой город через транспортную
                        компанию
                    </div>
...
<script>
    $('.wrapp-service-support .list-shops .item-service').on('click', function (event) {
        var self = $(this);
        $.ajax({
            url: '/local/ajax/add_shop.php',
            data: {
                id: $(this).data('id')
            },
            success: function (data) {
                $('.wrapp-service-support .list-shops .item-service').removeClass('active');
